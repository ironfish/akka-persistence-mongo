...
// SHAMELESSLY TAKEN FROM - https://github.com/akka/akka/blob/master/akka-samples/akka-sample-persistence-scala/src/main/scala/sample/persistence/EventsourcedExample.scala
// WILL BE REPLACED by Sean's Example. Used for testing Maven Central Snapshot Repository.
